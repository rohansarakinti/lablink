...
export function CompactFileUpload({
  ...
  return (
    <div className="space-y-2">
      <label htmlFor={inputId} className="text-sm font-medium text-ll-navy">
        {label}
      </label>
      <input
        ref={inputRef}
      ...
      >
        ...
        <span className="rounded-md bg-[#0f3441] px-2 py-1 text-xs font-semibold uppercase tracking-wide text-white">
          Choose file
        </span>
      </button>
