...
export default async function LabOverviewPage({
  ...
  const stats = [
    { label: "Total members", value: memberCount ?? 0, accent: "bg-ll-navy" },
    { label: "Open postings", value: openPostingCount ?? 0, accent: "bg-ll-purple" },
    { label: "Applications this month", value: appsCount ?? 0, accent: "bg-ll-navy/70" },
    { label: "Followers", value: followersCount ?? 0, accent: "bg-ll-purple/60" },
  ];
