      ...
      <div className="mx-auto flex w-full max-w-[1600px] flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:gap-4 md:px-6">
        <form onSubmit={onSubmit} className="relative min-w-0 flex-1">
          ...
          <input
            ...
            autoComplete="off"
            className="w-full rounded-xl border border-zinc-200 bg-white py-3 pl-4 pr-12 text-sm text-zinc-900 shadow-sm placeholder:text-zinc-400 focus:border-ll-purple focus:outline-none focus:ring-2 focus:ring-ll-purple/25"
          />
          <button
            type="submit"
            className="absolute right-2 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-lg text-zinc-500 hover:bg-zinc-100 hover:text-ll-navy"
            aria-label="Search"
          >
